  ...
  return {
    ...
    crypto: [
      { name: 'Métriques On-Chain', indicators: [
        { id:'mvrv',      name:'MVRV Z-Score',           val:65, sig:'buy',     w:3, raw:'1.8',     unit:'',        source:'simulated', desc:'MVRV Z-Score à 1.8 — sous la zone de distribution. (Glassnode payant)' },
        { id:'nvt',       name:'NVT Signal',             val:50, sig:'neutral', w:2, raw:'Neutre',  unit:'',        source:'simulated', desc:'NVT dans la normale. (données simulées)' },
      ...
      { name: 'Analyse Technique BTC', indicators: [
        ...
        { id:'btcsupp',   name:'Support / Résistance',   val:72, sig:'buy',     w:2, raw:'Au-dessus',unit:'',       source:'simulated', desc:'Bitcoin au-dessus de ses supports clés. (données simulées)' },
      ]},
    ],
    matieres: [
